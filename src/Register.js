                ...
                <main className="pa4 black-80">
                    <div className="measure">
                        ...
                        <div className="mt3">
                            ...
                            <input className="pa2 input-reset ba bg-transparent hover-white w-100" type="text" name="codeforces-handle"  id="codeforces-handle"/>
                        </div>
                        <div className="mt3">
                        ...
                        <div className="mv3">
                            ...
                            <input className="b pa2 input-reset ba bg-transparent hover-white w-100" type="password" name="cpassword"  id="cpassword"/>
                        </div>
                        </fieldset>
                        <div className="">
